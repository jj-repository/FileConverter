    ...
    def test_convert_with_h264_codec(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "mp4", "codec": "libx264"},
            )
    ...
    def test_convert_with_h265_codec(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "mp4", "codec": "libx265"},
            )
    ...
    def test_convert_with_vp9_codec(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "webm", "codec": "libvpx-vp9"},
            )
    ...
    def test_convert_with_720p_resolution(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "mp4", "resolution": "720p"},
            )
    ...
    def test_convert_with_1080p_resolution(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "mp4", "resolution": "1080p"},
            )
    ...
    def test_convert_with_custom_bitrate(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "mp4", "bitrate": "5M"},
            )
    ...
    def test_convert_invalid_codec(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "mp4", "codec": "invalid_codec_xyz"},
            )
...
class TestVideoDownload:
    ...
    def test_download_converted_file(self, client, sample_video):
        ...
        assert download_response.headers["content-type"] == "video/webm"
...
class TestVideoInfo:
    ...
    def test_get_video_info_success(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post("/api/video/info", files={"file": ("test.mp4", f, "video/mp4")})
    ...
    def test_get_video_info_invalid_file(self, client, temp_dir):
        ...
        with open(invalid_file, "rb") as f:
            response = client.post(
                "/api/video/info", files={"file": ("invalid.txt", f, "text/plain")}
            )
    ...
    def test_convert_with_resolution_and_codec(self, client, sample_video):
        ...
        with open(sample_video, "rb") as f:
            response = client.post(
                "/api/video/convert",
                files={"file": ("test.mp4", f, "video/mp4")},
                data={"output_format": "webm", "codec": "libvpx-vp9", "resolution": "1080p"},
            )
